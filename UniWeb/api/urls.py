...
urlpatterns = [
    ...
    #STUDENT URLS
    path('students-list/', views.Api_students_view.as_view(), name='students-list'),
    path('student/<int:pk>', views.api_student_details_view, name='student-details'),

    #ACADEMICS URLS
    path('complete-academics-list', views.Api_admin_academic_view.as_view(),
         name='complete-academics-list'),
    path('academics-details', views.Api_academic_view.as_view(),
         name='academics-details'),
    path('academics-list', views.Api_academic_list_view.as_view(),
         name='academics-list'),

    #INTERNSHIP APPLICANT URL
    path('internship-applicant-list',
         views.Api_internship_applicant_view.as_view(), name='internship-applicant-list'),
