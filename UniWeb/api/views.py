...
from UniWeb.models import Academic, Student, User, InternshipApplicant, Teacher
...
def api_links_admin_view(request, format=None):
    links = {
        'links-list': reverse('api:links-list', request=request, format=format),
        'all-users': reverse('api:all-users', request=request, format=format),
        'students-list': reverse('api:students-list', request=request, format=format),
        'academic-list': reverse('api:complete-academics-list', request=request, format=format),
        'internship-applicant-list': reverse('api:internship-applicant-list', request=request, format=format),
    }
