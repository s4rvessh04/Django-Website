...
from UniWeb.models import Academic, Student, Teacher, Semester, InternshipApplicant, ApiUser
from UniWeb.forms import CareersInternshipform, ApiUserRegistrationForm, UpdateUserDetails
